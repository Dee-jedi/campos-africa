      ...
      >
        <div>
          ...
          <div className="flex items-center justify-between pb-5 mb-5 border-b border-slate-100 pr-12 min-h-[44px]">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-geist text-xl font-black text-campos-navy tracking-tight">
                Campos
              </span>
            </div>
          </div>
          ...
          {/* Navigation Links */}
          <nav className="flex flex-col py-2 gap-2">
            {NAV_LINKS.map((link) => (
              <a
                key={link.label}
                href={link.href}
                onClick={onClose}
                className="flex items-center justify-between py-3.5 px-4 rounded-xl text-base font-bold text-slate-800 hover:text-campos-navy hover:bg-slate-50 transition-colors"
              >
        ...
        <div className="pt-6 border-t border-slate-100 flex flex-col gap-2.5">
          <Link
            href="/get-app"
            onClick={onClose}
            className="w-full flex items-center justify-center gap-2 py-3.5 px-6 rounded-full bg-campos-navy hover:bg-slate-900 text-white font-bold text-[1.05rem] shadow-lg shadow-campos-navy/20 active:scale-[0.98] transition-all"
          >
            <span>Get App</span>
          ...
          <Link
            href="/web-app"
            onClick={onClose}
            className="w-full flex items-center justify-center gap-2 py-3.5 px-6 rounded-full bg-transparent border-2 border-slate-200 hover:border-campos-navy text-campos-navy font-bold text-[1.05rem] active:scale-[0.98] transition-all"
          >
